  ...
  return (
    <div className="App">
      <div className="App-header">
        ...
        <Immagine paragrafo2="messo per primo nella pagina app.js ma secondo in immmagine.jsx" />
         <Immagine paragrafo="messo per primo nella pagina immagine.jsx ma secondo in app.js" />
      </div>
    </div>
  );
}
